...
var Witness = /** @class */ (function () {
    ...
    Witness.prototype.getAttributes = function () {
        return this.attributes;
    };
    Witness.prototype.getSig = function () {
        return this.sig;
    };
    Witness.fromSig = function (authID, mdDoc, subjectSig, sig) {
        var decodedSig = jsonwebtoken_1.default.decode(sig);
        return new Witness(authID, mdDoc, subjectSig, decodedSig["attributes"], sig);
    };
    return Witness;
}());
